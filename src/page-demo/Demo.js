                    ...
                    <div className="home-demo-area bg_color--1 ptb--120">
                        <div className="wrapper plr--120">
                            ...
                            <div className="row">
                                ...
                                <div className="col-lg-4 col-md-6 col-sm-6 col-12">
                                    <div className="single-demo">
                                        <a target="_blank" href="/portfolio-landing">
                                            <img src="/assets/images/preview/personal-portfolio-landing.png" alt="Portfolio Landing"/>
                                            <h3 className="title">Landing Page (Personal Portfolio)</h3>
                                            <p className="info">It comes with landing page feature. This tamplate you can be used for your Personal useses,  Freelancer, Designer, and Developer etc.</p>
                                ...
                                <div className="col-lg-4 col-md-6 col-sm-6 col-12">
                                    <div className="single-demo">
                                        <a target="_blank" href="/creative-landing">
                                            <img src="/assets/images/preview/creative-landing.png" alt="Creative Landing"/>
                                            <h3 className="title">Landing Page (Creative Agency)</h3>
                                            <p className="info">Added creative agency landing page.When you need creative agency landing page you can be use it for your creative agency, Digital agency landing page page.</p>
                                            <div className="label-new">
                                                <span>New</span>
                                            </div>
                                        </a>
                                ...
                                <div className="col-lg-4 col-md-6 col-sm-6 col-12">
                                    <div className="single-demo">
                                        <a target="_blank" href="/home-particles">
                                            <img src="/assets/images/preview/homeparticles.png" alt="Creative Landing"/>
                                            <h3 className="title">Home Particle (Landing Page)</h3>
                                            <p className="info">Home particle has most feature is particles animation.It can be used for your creative agency, Business agency, Digital agency and so on, And it has Landing page added.</p>
                                            <div className="label-new">
                                                <span>New</span>
                                            </div>
                                        </a>
